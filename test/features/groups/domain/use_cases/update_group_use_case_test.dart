...
void main() {
  ...
  setUp(() {
    ...
    useCase = UpdateGroupUseCase(mockRepository);
  });
  ...
  group('UpdateGroupUseCase', () {
    ...
    group('validate', () {
      test('should throw exception when group ID is empty', () {
        // Arrange
        final invalidGroup = testGroup.copyWith(id: '');
    ...
    group('execute', () {
      test('should call repository updateGroup with valid group', () async {
        // Arrange
        ...
        verify(mockRepository.updateGroup(testGroup)).called(1);
      });
